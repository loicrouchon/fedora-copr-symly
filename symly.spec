...
Source0:   https://github.com/loicrouchon/symly/archive/refs/tags/v0.11.3.tar.gz
...
%prep
%setup -q -n symly-0.11.3

%build
ant -f tools/packaging/fedora/build.xml -Dproject.version="0.11.3" -v
