...
# Source0:   https://github.com/loicrouchon/jvm-finder/archive/refs/tags/v0.2.1.tar.gz
Source0:   https://github.com/loicrouchon/jvm-finder/archive/refs/heads/packaging/fedora.zip
...
%setup -q -n jvm-finder-packaging-fedora
%build
